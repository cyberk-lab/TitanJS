...
```sh
npm install @titanlabjs/ethereum
```

In the frontend

``` typescript
import { SignerFromBrowser } from "@titanlabjs/ethereum/signers/SignerFromBrowser"
...
``` typescript
import { SignerFromPrivateKey } from "@titanlabjs/ethereum/signers/SignerFromPrivateKey"
...
- **SignerFromPrivateKey** from `@titanlabjs/ethereum/signers/SignerFromPrivateKey`
- **SignerFromBrowser** from `@titanlabjs/ethereum/signers/SignerFromBrowser`
